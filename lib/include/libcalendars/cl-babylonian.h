...
LIBCALENDAR_API uint8_t  ba_is_valid(int16_t year, uint8_t month, uint16_t day);
LIBCALENDAR_API void ba_to_jdn(uint32_t* jd,
                               int16_t year, uint8_t month, uint16_t day);
LIBCALENDAR_API void jdn_to_ba(uint32_t jdn,
                               int16_t* year, uint8_t* month, uint16_t* day);
