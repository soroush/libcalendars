...
LIBCALENDAR_API
uint8_t
ml_days_in_month (uint8_t month, int16_t year)
{
  switch (month)
    {
    case 1:
...
LIBCALENDAR_API
uint16_t
ml_days_in_year (int16_t year)
{
  return ml_is_leap (year) ? 366 : 365;
}

LIBCALENDAR_API uint8_t
ml_month_in_year (int16_t year)
{
  return 12;
}
...
LIBCALENDAR_API
uint8_t
ml_is_valid (int16_t year, uint8_t month, uint16_t day)
{
...
LIBCALENDAR_API
void
ml_to_jdn (uint32_t *jd, int16_t year, uint8_t month, uint16_t day)
{
  int8_t c0;
  int16_t x1 = 0;
  int16_t x2 = 0;
  ...
  x3 = fdiv (x4, 100);
  x2 = mod (x4, 100);
  *jd = fdiv (328718 * x3 + 6, 9) + fdiv (36525 * x2, 100)
        + fdiv (153 * x1 + 2, 5) + day + 1721119;
}

LIBCALENDAR_API
void
jdn_to_ml (uint32_t jd, int16_t *year, uint8_t *month, uint16_t *day)
{
  ...
  const int32_t x1 = fdiv (5 * fdiv (mod (k2, 36525), 100) + 2, 153);
...
LIBCALENDAR_API
void
ml_to_gr (int16_t jyear, uint8_t jmonth, uint16_t jday, int16_t *gyear,
...
LIBCALENDAR_API
void
gr_to_ml (int16_t gyear, uint8_t gmonth, uint16_t gday, int16_t *jyear,
