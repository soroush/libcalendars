...
LIBCALENDAR_API
uint8_t
is_leap (uint8_t calendar, int16_t year)
{
  switch (calendar)
    {
    case CAL_GREGORIAN:
...
LIBCALENDAR_API
uint16_t
days_in_year (uint8_t calendar, int16_t year)
{
  switch (calendar)
    {
    case CAL_GREGORIAN:
...
LIBCALENDAR_API uint8_t
month_in_year (uint8_t calendar, int16_t year)
{
  switch (calendar)
    {
    case CAL_GREGORIAN:
...
LIBCALENDAR_API uint8_t
is_valid (uint8_t calendar, int16_t year, uint8_t month, uint16_t day)
{
  switch (calendar)
    {
    case CAL_GREGORIAN:
...
LIBCALENDAR_API void
to_jdn (uint8_t calendar, uint32_t *jd, int16_t year, uint8_t month,
        uint16_t day)
{
  switch (calendar)
    {
...
LIBCALENDAR_API void
to_date (uint8_t calendar, uint32_t jd, int16_t *year, uint8_t *month,
         uint16_t *day)
{
  switch (calendar)
    {
...
LIBCALENDAR_API
void
convert_date (uint8_t icalendar, uint8_t ocalendar, int16_t iyear,
              uint8_t imonth, uint16_t iday, int16_t *oyear, uint8_t *omonth,
              uint16_t *oday)
{
  uint32_t jdn = 0;
