...
LIBCALENDAR_API
uint8_t eg_is_leap(int16_t year) {
    return 0;
}

LIBCALENDAR_API
uint8_t eg_days_in_month(uint8_t month, int16_t year) {
    if(month == 13)
        return 5;
    return 30;
}
...
LIBCALENDAR_API
uint16_t eg_days_in_year(int16_t year) {
    return 365;
}

LIBCALENDAR_API
uint8_t eg_month_in_year(int16_t year) {
    return 13;
}

LIBCALENDAR_API
uint8_t eg_is_valid(int16_t year, uint8_t month, uint16_t day) {
...
LIBCALENDAR_API
void eg_to_jdn(uint32_t* jd, int16_t year, uint8_t month, uint16_t day) {
    *jd = 365 * year + 30 * month + day + 1448242;
}

LIBCALENDAR_API
void jdn_to_eg(uint32_t jd, int16_t* year, uint8_t* month, uint16_t* day) {
...
LIBCALENDAR_API
void eg_to_gr(int16_t  jyear,  uint8_t jmonth,  uint16_t jday,
...
LIBCALENDAR_API
void gr_to_eg(int16_t  gyear,  uint8_t gmonth,  uint16_t gday,
