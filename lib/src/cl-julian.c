...
LIBCALENDAR_API
uint8_t
ju_days_in_month (uint8_t month, int16_t year)
{
  switch (month)
    {
    case 1:
...
LIBCALENDAR_API
void
ju_to_jdn (uint32_t *jd, int16_t year, uint8_t month, uint16_t day)
{
  int32_t c0 = 0;
  int32_t j1 = 0;
  int32_t j2 = 0;
...
LIBCALENDAR_API
void
jdn_to_ju (uint32_t jd, int16_t *year, uint8_t *month, uint16_t *day)
{
...
LIBCALENDAR_API
void
ju_to_gr (int16_t jyear, uint8_t jmonth, uint16_t jday, int16_t *gyear,
...
LIBCALENDAR_API
void
gr_to_ju (int16_t gyear, uint8_t gmonth, uint16_t gday, int16_t *jyear,
